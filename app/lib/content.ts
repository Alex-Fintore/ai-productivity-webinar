...
export const SCENARIOS: Scenario[] = [
  {
    ...
    estimate: 1.5,
    description:
      "Подготовить черновик ответа, сократить длинную переписку, составить напоминание или вежливый отказ.",
    delegate:
  ...
  },
  {
    ...
    estimate: 1.5,
    description:
      "Собрать протокол, выделить решения, открытые вопросы и ответственных, подготовить письмо по итогам.",
    delegate:
  ...
  },
  {
    ...
    estimate: 2,
    description:
      "Собрать первые источники, сравнить варианты и подготовить короткую записку с выводами.",
    delegate:
  ...
  },
  {
    ...
    estimate: 1.5,
    description:
      "Построить структуру, подготовить первый черновик, подобрать формулировки и сократить длинный материал.",
    delegate:
  ...
  },
  {
    ...
    estimate: 1.5,
    description:
      "Подобрать формулы, найти ошибки и объяснить, что изменилось в показателях.",
    delegate:
...
export const HISTORY = [
  ...
  ["2026", "Сервисы предлагают поиск по файлам, подключение инструментов и многошаговые сценарии"],
] as const;
